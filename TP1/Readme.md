...
## Integrantes / Autor
* **Nombre:** Victoria Villalba Tevez
* **Materia:** IISAIA — Introducción a la Ingeniería de Software Asistida por IA

---

## Descripción del Proyecto

Este proyecto consiste en un **formulario de registro de usuario** deliberadamente diseñado bajo el concepto de **Bad UI** (Interfaz Perversa). El objetivo es crear una experiencia totalmente frustrante y absurda pero **100% funcional**, donde cada campo exige una mecánica de interacción no convencional e hiper-sensible para ser completado con éxito.
